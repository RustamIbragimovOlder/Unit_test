...
//        assert weekends.length == 3; // ошибка
...
//        assert x >= 0; // ошибка
    ...
    public static int sum(int a, int b) {
        assert Integer.MAX_VALUE - a >= b : "Внимание! Переполнение разряда!";
        return a + b;
    }
...
//        assertThat(5).isEqualTo(sum(2, 3)); // неправильно!
        assertThat(sum(2, 3)).isEqualTo(5); // правильно!
    }
